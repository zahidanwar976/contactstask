	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a> <i class="fa fa-angle-right"></i></li>
                  <!-- <li><button type="submit" class="btn btn-primary left">Add Data</button></li> -->

            </ol>
            <!-- <ul class="list-group"> -->
  <!-- <li class="list-group-item btn btn-primary">Add Data</li> -->
              <a href="<?php echo base_url()?>Login/signup"><button class="btn btn-default">Add Data</button></a>
 <!-- </ul> -->
<!--four-grids here-->
